...
Vaihtoehtoinen tapa laskea sijalukuja on _ikkunafunktio_, jos käytetty tietokanta sallii sen. Esimerkiksi SQLiten uusissa versioissa ikkunafunktioiden `RANK` ja `ROW_NUMBER` avulla voidaan laskea vastaavat sijaluvut kuin äskeisissä esimerkeissä.
